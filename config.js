...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/zwFVTl3.jpg Selam {sender}, Bot Şu Kadar Zamandır Aktif: \n Uptime: {uptime}",
    ...
    PMB: process.env.PMB || '*Kişisel mesajlara izin verilmez. Engellendin!*',
    READ_COMMAND: convertToBool(process.env.READ_COMMAND) || true,
    SESSION: process.env.SESSION || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f","deb80cd12ababea1c9b9a8ad6ce3fab2","78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us',
    BOT_INFO: process.env.BOT_INFO || 'Morfin;spio347;0;https://i.imgur.com/zwFVTl3.jpg;https://dsc.gg/morfin',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'Morfin',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Morfin¹¹ꫂ;Morfin MD bot;https://i.imgur.com/zwFVTl3.jpg' : process.env.AUDIO_DATA,
